...
description: This skill should be used when the user asks to "create a route", "add a controller", "implement service layer", "add Prisma query", "set up middleware", "validate with Zod", or mentions Node.js/Express backend development. Covers layered architecture, BaseController pattern, error handling, Prisma, Sentry, and testing.
---
